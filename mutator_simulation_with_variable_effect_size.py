...
def main():
    ...
    ancestral_population = mutator_classes.Population(N=args.N,
                                                      ...
                                                      variable_selective_effect = args.variable_selective_effect)
...
def create_joblist():
    ...
    if simpleParams:
        ...
        default_params['outpath'] = '/home/ec2-user/Mutator/variableMutatorEffect_constant/'
